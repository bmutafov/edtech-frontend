const defaultTexts = {
  ...
  productPageBodyReviewsCountTitle: 'Reviews:',
  productPageBodyReviewGreatForTitle: 'Great for',
  productPageBodyReviewDrawbacksTitle: 'Drawbacks',
  productPageBodyReviewCTAText: 'Got an opinion yourself?',
  ...
  productPageBodyOverviewTitle: 'Product reviews overview',
  productPageBodyReviewDescriptionTitle: 'said',

  //ProductInfoCard.tsx
  productInfoCardButtonText: 'Visit website',
  productInfoCardRating: 'Overall Rating',
  productInfoCardSubtitle: 'Lorem Ipsum gfuyfgerkhfgiyger',
  productInfoCardSubtitle2: 'Categories',
