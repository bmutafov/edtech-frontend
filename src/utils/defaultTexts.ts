const defaultTexts = {
  ...
  registerNumberLabel: 'Mobile number (optional)',
  registerNumberPlaceholder: '+31 00 00 001',
  registerRoleLabel: 'Educational role*',
  registerRolePlaceholder: 'Select your role',
  registerInstituteLabel: 'Institute and department*',
  registerInstitutePlaceholder: 'Fontys - Computer science',
  ...
  navBarUserActionsSectionTitleLogin: 'Login to my account',
  navBarUserActionsSectionTitleRegister: 'Become member',
  navBarUserActionsLoginModalSidebarTitle: 'Hello!',
  navBarUserActionsRegisterModalSidebarTitle: 'Welcome',
  ...
  //ProductPageBody.tsx
  productPageBodyOverall: 'Overall Rating',
  productPageBodyUsability: 'Usability',
  productPageBodyEngagement: 'Engagement',
  productPageBodyEffective: 'Effectiveness',
  productPageBodyDisabledText1: 'INDIVIDUAL LEARNING',
  productPageBodyDisabledText2: 'MISSING CONTENT',
  productPageBodyReviewTitle: '1 Review',
  productPageBodyReviewTitle2: 'Great for',
  productPageBodyButtonText: 'LEAVE REVIEW',
  productPageBodyCompanyProfileTitle: 'Company Profile',
  productPageBodyCompanyProfileSubtitle: 'Visit Company Name',
  productPageBodyCompanyProfileContact: 'Contact',
  productPageBodyCompanyProfileEmail: '@email',
  productPageBodyCompanyProfileNumber: '+310617384646',
  productPageBodyCompanyProfileWebsite: 'company.com',
  productPageBodyCompanyProfilelocation: 'City, Country',
  productPageBodyDevelopmentTitle: 'Development Stage',
  productPageBodyDevelopmentSubtitle: 'In Production',
  productPageBodyDevelopmentTitle2: 'Description',
  productPageBodyDevelopmentSubtitle2:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo',
  productPageBodyAccountTitle: 'Account Name',
  productPageBodyAccountTitle2: 'At eripuit signiferumuque, vel',
  productPageBodyAccountSubtitle: 'Job Title',
  productPageBodyAccountSubtitle2:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  productPageBodyEducationalInstitution: 'Educational Institution',
  productPageBodyNumberOfPeople: 'Number of People Involved',
  productPageBodyDrawbacks: 'Drawbacks',

  //ProductInfoCard.tsx
  productInfoCardTitle: 'Products',
  productInfoCardButtonText: 'LEARN MORE',
  productInfoCardRating: '[3.0] Overall Rating',
  productInfoCardSubtitle: 'Lorem Ipsum gfuyfgerkhfgiyger',
  productInfoCardSubtitle2: 'Product Category',
  productInfoCardPrice: 'Price',
  productInfoCardPriceSubtitle: 'Free',
  productInfoCardGrade: 'Grade',
